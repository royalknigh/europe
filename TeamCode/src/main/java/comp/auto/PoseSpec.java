...
public class PoseSpec {
    ...
    public static Pose pickupPose = new Pose(8.7, 32, 0);

    public static Pose pickupPoseControl1 = new Pose(30, 30, 0);

    //              first sample
    public static Pose firstSample = new Pose(54, 25, 0);

    public static Pose firstPushControl1 = new Pose(17, 17, 0);

    public static Pose firstPushControl2 = new Pose(55, 44, 0);

    public static Pose firstPush = new Pose(25, 25, 0);

    //                  second sample
    public static Pose secondSample = new Pose(54, 20, 0);

    public static Pose secondSampleControl = new Pose(70, 25, 0);

    public static Pose secondPush = new Pose(25, 20, 0);


    public static Pose thirdSample = new Pose(54, 10, 0);

    public static Pose thirdSampleControl = new Pose(70, 15, 0);

    public static Pose thirdPush = new Pose(25, 10, 0);
